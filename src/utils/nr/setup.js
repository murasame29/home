const accountID = import.meta.env.NR_ACCOUNT_ID;
const trustKey = import.meta.env.NR_TRUST_KEY;
const agentID = import.meta.env.NR_AGENT_ID;
const licenseKey = import.meta.env.NR_LICENSE_KEY;
const applicationID = import.meta.env.NR_APPLICATION_ID;
